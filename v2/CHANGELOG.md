...
- [BUGFIX] Removes data races [#3](https://github.com/dnorton211153/raymond/issues/3) - Thanks [@markbates](https://github.com/markbates)

### Raymond 2.0.0 _(May 01, 2016)_

- [BUGFIX] Fixes passing of context in helper options [#2](https://github.com/dnorton211153/raymond/issues/2) - Thanks [@GhostRussia](https://github.com/GhostRussia)
...
- This is the first release. Raymond supports almost all handlebars features. See https://github.com/dnorton211153/raymond#limitations for a list of differences with the javascript implementation.
